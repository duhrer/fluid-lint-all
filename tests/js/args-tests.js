...
var testDefs = {
    noArgs: {
        ...
        args: [],
        expected: { "h": false, "help": false, showHelp: false, showMergedConfig: false }
    },
    invalidArgs: {
        message: "We should be able to handle invalid arguments.",
        args: ["--stuff=nonsense", "--configFile=foo"],
        errorKeys: ["stuff"],
        expected: { configFile: "foo", "h": false, "help": false, showHelp: false, showMergedConfig: false }
    },
    missingValues: {
        message: "We should be able to handle missing argument values.",
        args: ["--configFile", "--checks=foo"],
        errorKeys: ["configFile"],
        expected: { checks: ["foo"], "h": false, "help": false, showHelp: false, showMergedConfig: false  }
    },
    checksArrayNoQuotes: {
        message: "We should be able to handle a comma-delimited array of checks.",
        args: ["--checks=foo,bar,baz"],
        expected: { checks: ["foo", "bar", "baz"], "h": false, "help": false, showHelp: false, showMergedConfig: false  }
    ...
    checksQuotedArray: {
        ...
        expected: { checks: ["rice chex", "corn chex", "wheat chex", "pretzels", "peanuts"], "h": false, "help": false, showHelp: false, showMergedConfig: false  }
    },
    checksSingleValue: {
        message: "We should be able to handle missing argument values.",
        args: ["--checks=blank"],
        expected: { checks: ["blank"], "h": false, "help": false, showHelp: false, showMergedConfig: false  }
    }
};

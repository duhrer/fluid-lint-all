...
fluid.lintAll.parseArgs = function (processArgs) {
    var minimistOptions = minimist(processArgs.slice(2), {
        boolean: ["showMergedConfig", "showHelp", "showCheckedFiles", "changedOnly"],
    ...
    var supportedArgKeys = ["checks", "configFile", "showMergedConfig", "changedOnly", "showHelp", "showCheckedFiles", "help", "h"];
